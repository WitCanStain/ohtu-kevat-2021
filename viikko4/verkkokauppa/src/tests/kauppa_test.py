...
class TestKauppa(unittest.TestCase):
    ...
    def test_ostetaan_kaksi_samaa_tuotetta_ja_pankin_metodia_tilisiirto_kutsutaan(self):
    ...
    def ostetaan_kaksi_tuotetta_joista_toinen_loppu_ja_pankin_metodia_tilisiirto_kutsutaan(self):
